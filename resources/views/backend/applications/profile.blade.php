...
@section('title', "View candidate $info->full_name")
@section('content-header')
    Verification Status
    <small> {{$candidate->verified_status}}</small>
@stop
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive" src="{!! asset($info->image()) !!}"
                        ...
                        @if($candidate->verified_status == 'Not Verified')
                            <a title="This will mark the profile as Verified or Approved so that he can apply to any jobs that has been posted"
                               href="{!! route('admin.verify.profile', Hashids::encode($candidate->id)) !!}"
                        ...
                        @elseif($candidate->verified_status == 'Verified')
                            <a title="This will mark the profile as suspended or halted so that he can not apply to any job posted"
                               href="{!! route('admin.suspend.profile', Hashids::encode($candidate->id)) !!}"
            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <p class="text-muted">
                            {{ $info->address}}<br/>
                            {{ $info->district->name }}, {{ $info->district->city->name}}
                        </p>
                        <!-- <hr>
