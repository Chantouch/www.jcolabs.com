...
return [
    ...
    */
    ...
    'path' => [
        ...
        'controller' => app_path('Http/Controllers/Employer/'),
        ...
        'views' => base_path('resources/views/employers/'),
    ...
    */
    ...
    'namespace' => [
        ...
        'controller' => 'App\Http\Controllers\Employer',
    ...
    */
    ...
    'prefixes' => [
        ...
        'route' => 'employer',  // using admin will create route('admin.?.index') type routes
